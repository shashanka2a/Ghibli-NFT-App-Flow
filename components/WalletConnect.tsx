          ...
          {!isConnected ? (
            ...
            >
              ...
              <div className="text-center text-sm text-slate-500">
                <p className="mb-3">Choose your preferred Flow wallet:</p>
                <div className="grid grid-cols-1 gap-2">
                  <div className="flex justify-center gap-4">
                    <span className="px-3 py-1 bg-slate-100 rounded-full text-xs">Blocto</span>
                    <span className="px-3 py-1 bg-slate-100 rounded-full text-xs">Lilico</span>
                    <span className="px-3 py-1 bg-slate-100 rounded-full text-xs">Flow Wallet</span>
                  </div>
                  <div className="flex justify-center gap-4 mt-1">
                    <span className="px-3 py-1 bg-slate-100 rounded-full text-xs">Dapper</span>
                    <span className="px-3 py-1 bg-slate-100 rounded-full text-xs">Finoa</span>
                    <span className="px-3 py-1 bg-slate-100 rounded-full text-xs">Ledger</span>
                  </div>
                </div>
                <p className="text-xs mt-3 text-slate-400">
                  FCL will show available wallets automatically
                </p>
              </div>
            </motion.div>
          ) : (
